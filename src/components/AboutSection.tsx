...
export default function AboutSection() {
  return (
    <section
      id="about"
      className="py-20 sm:py-24 px-4 sm:px-6 lg:px-8 bg-cyber-darker relative z-10"
    >
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              <div className="space-y-3 sm:space-y-4 font-mono text-xs sm:text-sm">
                ...
                >
                  <p>
                    <span className="text-neon-green">NAME:</span> Fawwaz Al
                    Farisi
                  </p>
                  <p>
                    <span className="text-neon-green">ROLE:</span> Full Stack
                    Developer
                  </p>
                  <p>
                    <span className="text-neon-green">LOCATION:</span> Indonesia
                  </p>
                  <p>
                    <span className="text-neon-green">PASSION:</span> Creating
